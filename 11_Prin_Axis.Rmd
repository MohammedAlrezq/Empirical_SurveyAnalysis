...
corrplot(model_11_DV_corr, 
         method= "number",
         tl.col = "black",
         )# label variable in black

pairs.panels(model_11_DVs, pch = '.', lm = T, ellipses = F, scale = F, method = "pearson")
...
```
- Note theree might be multicollinearity with DVs (2.815678e-12) < 0.00001
