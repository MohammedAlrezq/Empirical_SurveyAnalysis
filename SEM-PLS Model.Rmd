...
boost_summary_HTMT <- summary(boost_model, alpha = 0.10)

# Bootstrap for the signifiant coefficient paths 
boost_summary_paths <- summary(boost_model, alpha = 0.05)
boost_summary_plot <- summary(boost_model)
```
...
plot(boost_summary_plot, title = "Bootstrapped Model")
