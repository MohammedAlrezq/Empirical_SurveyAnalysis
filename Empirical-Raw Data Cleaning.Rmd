...
Surv.data <-  Surv.data %>% 
  rename(IMPL_SUCC = X1..The.implementation.of.LP.LSS.was.successful.,
         ...
         ORG_IMP = X4..Organizational.performance.improved.after.implementing.LP.LSS., 
         EMPL_SKI = X5..Employees.knowledge..skills.and.abilities.improved.after.LP.LSS.implementation.,
         ...
         EMPL_BEL = X12..Employees.believed.that.using.LP.LSS.was.important.for.the.organization.,
...
# Data Imputation 
- This imputation section is divided into two subsections: imputation with subset of the data **(63 participants with 5% missing)** and imputation with the full dataset **(73 participants with 17% missing)**

## Imputation with subset/completed cases of the data (63 participants)
- this following chunks will includes only participants who had 1 missing questions. This is considered because it is recommended that a total of *missing questions* should *not exceed 5% per variable *
```{r}
# Select 63 participants
